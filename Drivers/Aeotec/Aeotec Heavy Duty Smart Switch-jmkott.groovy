 ...
 * Modified by J.M.Kott
 * Configuration is not committing to device.  Need to fix
 * Default settings don't make sense and its too chatty.  Who needs voltage every 5 seconds???
 * Set WATT report to 5 seconds, but enable Diff.  Reports are only sent each 5 seconds that it's change from prev by Diff values
...
metadata {
  definition (name: "Aeotec Heavy Duty Smart Switch-jmkott", namespace: "jmkott", author: "J.M.Kott", importUrl: "https://raw.githubusercontent.com/jmkott/Hubitat/main/Drivers/Aeotec/Aeotec%20Heavy%20Duty%20Smart%20Switch-jmkott.groovy") {
    capability "Actuator"
    capability "Switch"
    capability "Sensor"
  ...
  preferences {
    ...
    section { // Configuration
      ...
      input name: "param90", title: "Enable Params 91 and 92", description: "Enables/disables parameter Min wattage and percentage", type: "enum", options:[[0:"Disabled"],[1:"Enabled"]], defaultValue: 1, required: true
...
//    zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: param111.toInteger()),
    zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: 5),
    zwave.configurationV1.configurationSet(parameterNumber: 112, size: 4, scaledConfigurationValue: 600),
    zwave.configurationV1.configurationSet(parameterNumber: 113, size: 4, scaledConfigurationValue: 3600),
